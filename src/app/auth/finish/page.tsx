...
// Client-side magic-link landing page. Supabase's admin-generated magic
...
// supabase client (which writes cookies the server can read), and then
...
export default function AuthFinishPage() {
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      // Strip the hash so it isn't preserved across navigations, then go.
