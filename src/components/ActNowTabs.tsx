...
import { Mail, Flame, Phone } from "lucide-react";
...
// One "Act now" section instead of a long stack. Three tabs — Reply, Reactivate,
// Reach out — with only the active list shown, so the page stays short and it's
// obvious what needs Mitchell. Each list keeps its own draft/send behavior.
type Tab = "reply" | "reactivate" | "reachout";

export function ActNowTabs({
  inbox, inboxNote, reactivate, reachOut
}: {
  inbox: InboxThread[];
