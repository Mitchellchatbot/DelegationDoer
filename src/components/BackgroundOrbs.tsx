...
const SIDEBAR_ORBS: OrbSpec[] = [
  ...
  { size: 180, color: "rgba(139,92,246,0.42)",  top: "32%",      right: "-70px", amplitude: 22, duration: 17, delay: 1.2 },
  { size: 170, color: "rgba(168,85,247,0.40)",  bottom: "-50px", left: "-40px",  amplitude: 16, duration: 19, delay: 2.4 },
...
const CANVAS_ORBS: OrbSpec[] = [
  ...
  { size: 420, color: "rgba(139,92,246,0.16)",   top: "30%",     left: "-100px", amplitude: 36, duration: 26, delay: 1.8 },
  { size: 380, color: "rgba(59,130,246,0.18)",   bottom: "10%",  right: "-80px", amplitude: 28, duration: 24, delay: 0.9 },
  { size: 340, color: "rgba(168,85,247,0.14)",   bottom: "-80px", left: "30%",   amplitude: 24, duration: 28, delay: 3 },
