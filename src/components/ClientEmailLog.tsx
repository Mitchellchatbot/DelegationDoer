...
function kindBadgeTone(k: string) {
  // Accepts string + falls back to slate so a new draft kind shipping
  // in the DB before this lookup is updated can't crash the page.
  switch (k) {
