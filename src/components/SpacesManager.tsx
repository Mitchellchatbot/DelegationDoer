  ...
  return (
    <div className="rounded-xl border border-slate-200/80 bg-white p-3 space-y-2.5">
      ...
      <div>
        ...
        {showAcctPicker && (
          <div className="mt-2 rounded-xl border border-slate-200 bg-white p-2 grid grid-cols-1 sm:grid-cols-2 gap-1 shadow-sm">
            {inboxes
              ...
              .map((a) => (
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-medium text-ink truncate">{a.label || a.email}</div>
